...
class Beamformer:
    ...
    New beamformers should be added here. If no dedicated test case is added
    for a :class:`acoular.fbeamform.BeamformerBase` derived class, the class is still included
    in the test suite through the use of the `case_default` case.
