    ...
    def _get_result ( self ):
        ...
        while self.digest != _digest:
            ...
            if not ( # if result caching is active
                    ...
                    (config.global_caching == 'individual' and not self.cached)
                ):
#                print("get filecache..")
    ...
    def synthetic( self, f, num=0):
        ...
        if num == 0:
            ...
            if ind >= len(freq):
                ...
                if freq[ind] != f:
                    warn(f'Queried frequency ({f:g} Hz) not in set of '
            ...
            if ind1 == ind2:
                warn(f'Queried frequency band ({f1:g} to {f2:g} Hz) does not '
            ...
            if not fr[i]:
                ...
                for s in list(range(m,n+m)):
                    if eva[s] > 0:
                        ...
                        warn(f'Eigenvalue {s:g} <= 0 for frequency index {i:g}. Will not be calculated!',Warning, stacklevel = 2)
