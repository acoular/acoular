...
# %%
# Here, different frequency domain beamformers defined in the module :module:`acoular.fbeamform` are used and the corresponding result maps are calculated by
