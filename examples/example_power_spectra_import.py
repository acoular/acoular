...
from acoular import BeamformerBase, ImportGrid, L_p, MicGeom, PowerSpectraImport, RectGrid, SteeringVector
from acoular import __file__ as bpath
from pylab import array, colorbar, diag, figure, imshow, newaxis
...
st2 = SteeringVector(grid=ImportGrid(gpos_file=array([loc1, loc2, loc3]).T), mics=mg)
