...
# Dependencies
Acoular runs under Linux, Windows and MacOS, Python 3.7 - 3.11 is needed with the Numpy, Scipy, Traits, scikit-learn, pytables, numba packages available. Matplotlib is recommended, but not necessary.
