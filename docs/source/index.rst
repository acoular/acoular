...
.. raw:: html
  ...
  <style>#workshop2024 a{background:#dea712;color:#000;text-decoration:none;font-family:arial,sans-serif;text-align:center;font-weight:bold;padding:5px 40px;font-size:1rem;line-height:2rem;position:relative;transition:0.5s;}#workshop2024 a:hover{background:#fab700;color:#fff;}#workshop2024 a::before,#workshop2024 a::after{content:"";width:100%;display:block;position:absolute;top:1px;left:0;height:1px;background:#fff;}#workshop2024 a::after{bottom:1px;top:auto;}@media screen and (min-width:800px){#workshop2024{position:absolute;display:block;top:0;left:0;width:300px;overflow:hidden;height:300px;z-index:9999;}#workshop2024 a{width:300px;position:absolute;top:90px;left:-75px;transform:rotate(-45deg);-webkit-transform:rotate(-45deg);-ms-transform:rotate(-45deg);-moz-transform:rotate(-45deg);-o-transform:rotate(-45deg);box-shadow:4px 4px 10px rgba(0,0,0,0.8);}}</style><span id="workshop2024"><a href="https://www.tu.berlin/en/event-details/events/event/018c1020-419d-70b6-abcf-2220015bd233">Visit the Acoular Workshop!</a></span>
